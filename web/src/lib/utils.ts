...
/** App UI font only — use on layout shells; keep casing controlled by callers. */
export const themedFont = "font-sans";

/** App body copy — sentence-case themed text (not uppercase chrome). */
export const themedBody = "font-sans normal-case";

/** App brand chrome — uppercase section headers and nav labels. */
